...
<?php
	...
	$id_owner = $row['id'];
	$name = $row['name'];
	$sql = "SELECT * FROM menu WHERE owner_id = '$id_owner'";
	$result = mysqli_query($link, $sql);	
?>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			...
			<a href="?add_menu_form" class="btn btn-primary">Add menu</a>
			<br/><br/>
			<?php
				if(isset($_GET["add_menu_form"]))
				{
					
					echo 
					'
						<form action="?add_menu" method="post">
						 <input  placeholder="name" class="form-control" name="name" type="text" required="required"></input><br/>
						 <textarea placeholder="description" class="form-control" rows ="5" cols ="50" name="description"  required="required"></textarea><br/>	 
									...
									<?php	
										...
										echo'
											<tr class="odd gradeX">
												...
												<td><a href = "?manage_menu&menu_id='.$row['id'].'">manage</a></td>
											</tr>
											';
										}
									?>
