    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="width:300px">Owner - <b> <?php  include 'includes/db.inc.php'; 
								  ...
								  $sql = "SELECT name FROM staff_user WHERE id='$id'";
                                  $result = mysqli_query($link, $sql);
								  $row = mysqli_fetch_array($result);
								  echo $row['name'];
																				?> </p></b></a>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php include "includes/db.inc.php";	
															$email = $_SESSION['email'];
															$sql = "SELECT * FROM staff_user WHERE id_owner = '$id'";
															$result = mysqli_query($link, $sql);
